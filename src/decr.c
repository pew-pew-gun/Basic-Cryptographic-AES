...
int main(int argc, char **argv) {
  ...
  //Skeleton code modified so that the decr_buf string has space for a NULL byte at the end (null-terminated string)
  uint8_t *decr_buf = malloc(file_len * sizeof(uint8_t) + 1);
